...
final class RequestHeaders {
    ...
    public RequestHeaders(Uri uri, com.ConnectionProject.connection.libs.http.cache.RawHeaders headers) {
        this.uri = uri;
        ...
        com.ConnectionProject.connection.libs.http.cache.HeaderParser.CacheControlHandler handler = new com.ConnectionProject.connection.libs.http.cache.HeaderParser.CacheControlHandler() {
            @Override public void handle(String directive, String parameter) {
                if (directive.equalsIgnoreCase("no-cache")) {
                    ...
                    maxStaleSeconds = com.ConnectionProject.connection.libs.http.cache.HeaderParser.parseSeconds(parameter);
                } else if (directive.equalsIgnoreCase("min-fresh")) {
                    minFreshSeconds = com.ConnectionProject.connection.libs.http.cache.HeaderParser.parseSeconds(parameter);
