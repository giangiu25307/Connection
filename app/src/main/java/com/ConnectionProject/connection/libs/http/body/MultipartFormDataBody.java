...
import com.ConnectionProject.connection.libs.callback.ContinuationCallback;
...
import com.ConnectionProject.connection.libs.http.server.BoundaryEmitter;
...
public class MultipartFormDataBody extends BoundaryEmitter implements AsyncHttpRequestBody<Multimap> {
    ...
    com.ConnectionProject.connection.libs.http.body.Part lastPart;

    public interface MultipartCallback {
        public void onPart(com.ConnectionProject.connection.libs.http.body.Part part);
    }
    ...
    void handleLast() {
        ...
        com.ConnectionProject.connection.libs.http.body.StringPart part = new com.ConnectionProject.connection.libs.http.body.StringPart(name, value);
        ...
        liner.setLineCallback(new StringCallback() {
            ...
            public void onStringAvailable(String s) {
                if (!"\r".equals(s)){
                    ...
                    com.ConnectionProject.connection.libs.http.body.Part part = new com.ConnectionProject.connection.libs.http.body.Part(headers);
                    if (mCallback != null)
...
//                    sink.close();
        ...
        for (final com.ConnectionProject.connection.libs.http.body.Part part: mParts) {
            c.add(new ContinuationCallback() {
                @Override
                public void onContinue(Continuation continuation, CompletedCallback next) throws Exception {
                    byte[] bytes = part.getRawHeaders().toPrefixString(getBoundaryStart()).getBytes();
                    com.ConnectionProject.connection.libs.Util.writeAll(sink, bytes, next);
    ...
    public List<com.ConnectionProject.connection.libs.http.body.Part> getParts() {
        if (mParts == null)
            return null;
    ...
    private ArrayList<com.ConnectionProject.connection.libs.http.body.Part> mParts;
    public void addPart(com.ConnectionProject.connection.libs.http.body.Part part) {
        if (mParts == null)
            mParts = new ArrayList<com.ConnectionProject.connection.libs.http.body.Part>();
        mParts.add(part);
    }
