...
public class DataEmitterReader implements DataCallback {
    ...
    com.ConnectionProject.connection.libs.ByteBufferList mPendingData = new com.ConnectionProject.connection.libs.ByteBufferList();
    ...
    private boolean handlePendingData(com.ConnectionProject.connection.libs.DataEmitter emitter) {
