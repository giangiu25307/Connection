...
import com.ConnectionProject.connection.libs.http.server.AsyncHttpServerRequest;
import com.ConnectionProject.connection.libs.http.server.AsyncHttpServerResponse;
...
public class WebSocketImpl implements com.ConnectionProject.connection.libs.http.WebSocket {
    @Override
    public void end() {
        mSocket.end();
    }
    ...
    private void setupParser(boolean masking, boolean deflate) {
        mParser = new com.ConnectionProject.connection.libs.http.HybiParser(mSocket) {
            @Override
...
//            response.getHeaders().getHeaders().set("Access-Control-Allow-Origin", "http://" + origin);
    ...
    public static void addWebSocketUpgradeHeaders(AsyncHttpRequest req, String... protocols) {
        com.ConnectionProject.connection.libs.http.Headers headers = req.getHeaders();
...
//                return null;
    ...
    com.ConnectionProject.connection.libs.http.HybiParser mParser;
