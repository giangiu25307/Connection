...
import com.ConnectionProject.connection.libs.AsyncSemaphore;
...
public class SimpleFuture<T> extends SimpleCancellable implements DependentFuture<T> {
    ...
    public SimpleFuture(com.ConnectionProject.connection.libs.future.Future<T> future) {
        setComplete(future);
    }
    ...
    private com.ConnectionProject.connection.libs.future.Future<T> setComplete(com.ConnectionProject.connection.libs.future.Future<T> future, FutureCallsite callsite) {
        setParent(future);
     ...
     * @return
     */
    public com.ConnectionProject.connection.libs.future.Future<T> setComplete(com.ConnectionProject.connection.libs.future.Future<T> future) {
        return setComplete(future, null);
    }

    public com.ConnectionProject.connection.libs.future.Future<T> setCompleteFuture(com.ConnectionProject.connection.libs.future.Future<T> future) {
        return setComplete(future, null);
    }
    ...
    @Override
    public com.ConnectionProject.connection.libs.future.Future<T> done(DoneCallback<T> done) {
    ...
    @Override
    public com.ConnectionProject.connection.libs.future.Future<T> success(SuccessCallback<T> callback) {
        final SimpleFuture<T> ret = new SimpleFuture<>();
        ret.setParent(this);
        setCallbackInternal(null, (e, result, next) -> {
            if (e == null) {
    ...
    @Override
    public <R> com.ConnectionProject.connection.libs.future.Future<R> then(ThenFutureCallback<R, T> then) {
        ...
        setCallbackInternal(null, (e, result, next) -> {
            ...
            com.ConnectionProject.connection.libs.future.Future<R> out;
            try {
    ...
    @Override
    public <R> com.ConnectionProject.connection.libs.future.Future<R> thenConvert(final ThenCallback<R, T> callback) {
        return then(from -> new SimpleFuture<>(callback.then(from)));
    }

    @Override
    public com.ConnectionProject.connection.libs.future.Future<T> fail(FailCallback fail) {
    ...
    @Override
    public com.ConnectionProject.connection.libs.future.Future<T> failRecover(FailRecoverCallback<T> fail) {
        SimpleFuture<T> ret = new SimpleFuture<>();
        ret.setParent(this);
        setCallbackInternal(null, (e, result, next) -> {
            if (e == null) {
            ...
            com.ConnectionProject.connection.libs.future.Future<T> out;
            try {
                out = fail.fail(e);
            }
            catch (Exception callbackException) {
