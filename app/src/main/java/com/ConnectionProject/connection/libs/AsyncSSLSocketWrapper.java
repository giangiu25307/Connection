...
import com.ConnectionProject.connection.libs.http.SSLEngineSNIConfigurator;
...
import com.ConnectionProject.connection.libs.wrapper.AsyncSocketWrapper;
...
public class AsyncSSLSocketWrapper implements AsyncSocketWrapper, com.ConnectionProject.connection.libs.AsyncSSLSocket {
    ...
    com.ConnectionProject.connection.libs.AsyncSocket mSocket;
    ...
    public static void handshake(com.ConnectionProject.connection.libs.AsyncSocket socket,
    ...
    public static Cancellable connectSocket(com.ConnectionProject.connection.libs.AsyncServer server, String host, int port, InetSocketAddress local, ConnectCallback callback) {
        return connectSocket(server, host, port, local,false, callback);
    }
    public static Cancellable connectSocket(com.ConnectionProject.connection.libs.AsyncServer server, String host, int port, InetSocketAddress local, boolean trustAllCerts, ConnectCallback callback) {
    ...
    private AsyncSSLSocketWrapper(com.ConnectionProject.connection.libs.AsyncSocket socket,
                                  String host, int port,
                                  SSLEngine sslEngine,
                                  TrustManager[] trustManagers, HostnameVerifier verifier, boolean clientMode) {
        mSocket = socket;
...
//                ex.printStackTrace();
        ...
        try {
            if (!finishedHandshake && (engine.getHandshakeStatus() == HandshakeStatus.NOT_HANDSHAKING || engine.getHandshakeStatus() == HandshakeStatus.FINISHED)) {
                if (clientMode) {
                    ...
                    if (!trusted) {
                        com.ConnectionProject.connection.libs.AsyncSSLException e = new AsyncSSLException(peerUnverifiedCause);
                        report(e);
                        if (!e.getIgnore())
                            throw e;
                    }
    ...
    @Override
    public com.ConnectionProject.connection.libs.AsyncServer getServer() {
        return mSocket.getServer();
    }

    @Override
    public com.ConnectionProject.connection.libs.AsyncSocket getSocket() {
        return mSocket;
    }
    ...
    public static com.ConnectionProject.connection.libs.AsyncSSLServerSocket listenSecure(final Context context, final com.ConnectionProject.connection.libs.AsyncServer server, final String subjectName, final InetAddress host, final int port, final ListenCallback handler) {
        final ObjectHolder<com.ConnectionProject.connection.libs.AsyncSSLServerSocket> holder = new ObjectHolder<>();
        server.run(() -> {
            try {
    ...
    public static com.ConnectionProject.connection.libs.AsyncSSLServerSocket listenSecure(com.ConnectionProject.connection.libs.AsyncServer server, String keyDer, String certDer, final InetAddress host, final int port, final ListenCallback handler) {
    ...
    public static com.ConnectionProject.connection.libs.AsyncSSLServerSocket listenSecure(final com.ConnectionProject.connection.libs.AsyncServer server, final byte[] keyDer, final byte[] certDer, final InetAddress host, final int port, final ListenCallback handler) {
        final ObjectHolder<com.ConnectionProject.connection.libs.AsyncSSLServerSocket> holder = new ObjectHolder<>();
        server.run(() -> {
            try {
    ...
    public static com.ConnectionProject.connection.libs.AsyncSSLServerSocket listenSecure(final com.ConnectionProject.connection.libs.AsyncServer server, final PrivateKey pk, final Certificate cert, final InetAddress host, final int port, final ListenCallback handler) {
        final ObjectHolder<com.ConnectionProject.connection.libs.AsyncSSLServerSocket> holder = new ObjectHolder<>();
        server.run(() -> {
            try {
                ...
                final com.ConnectionProject.connection.libs.AsyncServerSocket socket = listenSecure(server, sslContext, host, port, handler);
    ...
    public static com.ConnectionProject.connection.libs.AsyncServerSocket listenSecure(AsyncServer server, final SSLContext sslContext, final InetAddress host, final int port, final ListenCallback handler) {
