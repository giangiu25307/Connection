...
import com.ConnectionProject.connection.libs.http.AsyncHttpHead;
import com.ConnectionProject.connection.libs.http.AsyncHttpPost;
import com.ConnectionProject.connection.libs.http.WebSocket;
import com.ConnectionProject.connection.libs.http.WebSocketImpl;
...
public class AsyncHttpServerRouter implements com.ConnectionProject.connection.libs.http.server.RouteMatcher {
    ...
    public void websocket(String regex, final com.ConnectionProject.connection.libs.http.server.AsyncHttpServer.WebSocketRequestCallback callback) {
    ...
    abstract class AsyncHttpServerRequestImpl extends com.ConnectionProject.connection.libs.http.server.AsyncHttpServerRequestImpl {
        Matcher matcher;
        @Override
    ...
    class Callback implements HttpServerRequestCallback, com.ConnectionProject.connection.libs.http.server.RouteMatcher {
        @Override
    ...
    public RouteMatch route(String method, String path) {
        synchronized (routes) {
            for (RouteInfo p: routes) {
                ...
                if (m.matches()) {
                    if (p.callback instanceof com.ConnectionProject.connection.libs.http.server.RouteMatcher) {
