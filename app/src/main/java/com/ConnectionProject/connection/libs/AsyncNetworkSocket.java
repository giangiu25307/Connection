...
public class AsyncNetworkSocket implements AsyncSocket {
    ...
    com.ConnectionProject.connection.libs.ChannelWrapper getChannel() {
        return mChannel;
    }
    ...
    private com.ConnectionProject.connection.libs.ChannelWrapper mChannel;
    private SelectionKey mKey;
    private com.ConnectionProject.connection.libs.AsyncServer mServer;
    
    void setup(com.ConnectionProject.connection.libs.AsyncServer server, SelectionKey key) {
        mServer = server;
        mKey = key;
    }
    
    @Override
    public void write(final com.ConnectionProject.connection.libs.ByteBufferList list) {
    ...
    private com.ConnectionProject.connection.libs.ByteBufferList pending = new com.ConnectionProject.connection.libs.ByteBufferList();
...
//                }
            pending.add(b);
            com.ConnectionProject.connection.libs.Util.emitAllData(this, pending);
        }
        else {
