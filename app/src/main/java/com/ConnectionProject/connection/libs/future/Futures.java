...
public class Futures {
    public static <T> com.ConnectionProject.connection.libs.future.Future<List<T>> waitAll(final List<com.ConnectionProject.connection.libs.future.Future<T>> futures) {
    ...
    public static <T> com.ConnectionProject.connection.libs.future.Future<List<T>> waitAll(final com.ConnectionProject.connection.libs.future.Future<T>... futures) {
    ...
    public static <T, F> com.ConnectionProject.connection.libs.future.Future<T> loopUntil(final Iterable<F> values, ThenFutureCallback<T, F> callback) {
