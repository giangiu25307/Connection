...
public class Multicast_WLAN extends Multicast {
    public Multicast_WLAN(Database database, ConnectionController connectionController) {
                ...
                */
                    ...
                    case "GO_LEAVES_BYE":
                        ...
                        if (MyNetworkInterface.getMyP2pNetworkInterface("p2p-wlan0-0") != null) {
                            ...
                            if(ConnectionController.myUser.getIdUser().equals(splittedR[1]))connectionController.createGroup();
