...
import com.example.connection.libs.ChannelWrapper;
import com.example.connection.libs.DatagramChannelWrapper;
import com.example.connection.libs.SocketChannelWrapper;
...
public class AsyncNetworkSocket implements AsyncSocket {
    ...
    com.example.connection.libs.ChannelWrapper getChannel() {
        return mChannel;
    }
    ...
    private com.example.connection.libs.ChannelWrapper mChannel;
    private SelectionKey mKey;
    private com.example.connection.libs.AsyncServer mServer;
    
    void setup(com.example.connection.libs.AsyncServer server, SelectionKey key) {
        mServer = server;
        mKey = key;
    }
    
    @Override
    public void write(final com.example.connection.libs.ByteBufferList list) {
    ...
    private com.example.connection.libs.ByteBufferList pending = new com.example.connection.libs.ByteBufferList();
...
//                }
            pending.add(b);
            com.example.connection.libs.Util.emitAllData(this, pending);
        }
        else {
