...
import com.example.connection.libs.AsyncSemaphore;
import com.example.connection.libs.future.Cancellable;
import com.example.connection.libs.future.DependentFuture;
import com.example.connection.libs.future.DoneCallback;
import com.example.connection.libs.future.FailCallback;
import com.example.connection.libs.future.FailConvertCallback;
import com.example.connection.libs.future.FailRecoverCallback;
...
import com.example.connection.libs.future.SuccessCallback;
import com.example.connection.libs.future.ThenCallback;
...
public class SimpleFuture<T> extends SimpleCancellable implements DependentFuture<T> {
    ...
    public SimpleFuture(com.example.connection.libs.future.Future<T> future) {
        setComplete(future);
    }
    ...
    private com.example.connection.libs.future.Future<T> setComplete(com.example.connection.libs.future.Future<T> future, FutureCallsite callsite) {
        setParent(future);
     ...
     * @return
     */
    public com.example.connection.libs.future.Future<T> setComplete(com.example.connection.libs.future.Future<T> future) {
        return setComplete(future, null);
    }

    public com.example.connection.libs.future.Future<T> setCompleteFuture(com.example.connection.libs.future.Future<T> future) {
        return setComplete(future, null);
    }
    ...
    @Override
    public com.example.connection.libs.future.Future<T> done(DoneCallback<T> done) {
    ...
    @Override
    public com.example.connection.libs.future.Future<T> success(SuccessCallback<T> callback) {
        final SimpleFuture<T> ret = new SimpleFuture<>();
        ret.setParent(this);
        setCallbackInternal(null, (e, result, next) -> {
            if (e == null) {
    ...
    @Override
    public <R> com.example.connection.libs.future.Future<R> then(ThenFutureCallback<R, T> then) {
        ...
        setCallbackInternal(null, (e, result, next) -> {
            ...
            com.example.connection.libs.future.Future<R> out;
            try {
    ...
    @Override
    public <R> com.example.connection.libs.future.Future<R> thenConvert(final ThenCallback<R, T> callback) {
        return then(from -> new SimpleFuture<>(callback.then(from)));
    }

    @Override
    public com.example.connection.libs.future.Future<T> fail(FailCallback fail) {
    ...
    @Override
    public com.example.connection.libs.future.Future<T> failRecover(FailRecoverCallback<T> fail) {
        SimpleFuture<T> ret = new SimpleFuture<>();
        ret.setParent(this);
        setCallbackInternal(null, (e, result, next) -> {
            if (e == null) {
            ...
            com.example.connection.libs.future.Future<T> out;
            try {
                out = fail.fail(e);
            }
            catch (Exception callbackException) {
