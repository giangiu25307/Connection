...
import com.example.connection.libs.http.ConnectionClosedException;
...
abstract class AsyncHttpResponseImpl extends FilteredDataEmitter implements DataEmitter, AsyncHttpResponse, AsyncHttpClientMiddleware.ResponseHead {
    ...
    @Override
    public com.example.connection.libs.http.AsyncHttpRequest getRequest() {
        return mRequest;
    }
    ...
    private com.example.connection.libs.http.AsyncHttpRequest mRequest;
    private AsyncSocket mSocket;
    protected com.example.connection.libs.http.Headers mHeaders;
    ...
    @Override
    public com.example.connection.libs.http.Headers headers() {
        return mHeaders;
    }
    ...
    public String charset() {
        com.example.connection.libs.http.Multimap mm = Multimap.parseSemicolonDelimited(headers().get("Content-Type"));
        String cs;
