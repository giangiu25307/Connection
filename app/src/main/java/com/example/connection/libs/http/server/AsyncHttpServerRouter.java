...
public class AsyncHttpServerRouter implements com.example.connection.libs.http.server.RouteMatcher {
    ...
    public void websocket(String regex, final com.example.connection.libs.http.server.AsyncHttpServer.WebSocketRequestCallback callback) {
    ...
    abstract class AsyncHttpServerRequestImpl extends com.example.connection.libs.http.server.AsyncHttpServerRequestImpl {
        Matcher matcher;
        @Override
    ...
    class Callback implements HttpServerRequestCallback, com.example.connection.libs.http.server.RouteMatcher {
        @Override
    ...
    public RouteMatch route(String method, String path) {
        synchronized (routes) {
            for (RouteInfo p: routes) {
                ...
                if (m.matches()) {
                    if (p.callback instanceof com.example.connection.libs.http.server.RouteMatcher) {
