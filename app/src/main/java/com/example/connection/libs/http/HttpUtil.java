...
import com.example.connection.libs.http.BodyDecoderException;
...
import com.example.connection.libs.http.body.JSONObjectBody;
import com.example.connection.libs.http.body.MultipartFormDataBody;
import com.example.connection.libs.http.body.StringBody;
import com.example.connection.libs.http.body.UrlEncodedFormBody;
import com.example.connection.libs.http.filter.ChunkedInputFilter;
import com.example.connection.libs.http.filter.ContentLengthFilter;
import com.example.connection.libs.http.filter.GZIPInputFilter;
import com.example.connection.libs.http.filter.InflaterInputFilter;

public class HttpUtil {
    public static AsyncHttpRequestBody getBody(DataEmitter emitter, CompletedCallback reporter, com.example.connection.libs.http.Headers headers) {
    ...
    public static DataEmitter getBodyDecoder(DataEmitter emitter, Protocol protocol, com.example.connection.libs.http.Headers headers, boolean server) {
    ...
    public static boolean isKeepAlive(Protocol protocol, com.example.connection.libs.http.Headers headers) {
    ...
    public static boolean isKeepAlive(String protocol, com.example.connection.libs.http.Headers headers) {
        // connection is always keep alive as this is an http/1.1 client
        String connection = headers.get("Connection");
        if (connection == null)
