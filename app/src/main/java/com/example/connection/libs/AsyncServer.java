...
import com.example.connection.libs.HostnameResolutionException;
 import com.example.connection.libs.SelectorWrapper;
 import com.example.connection.libs.ServerSocketChannelWrapper;
import com.example.connection.libs.ThreadQueue;
...
import com.example.connection.libs.callback.SocketCreateCallback;
import com.example.connection.libs.callback.ValueFunction;
...
public void setLocalAddress(String local){
    this.local=new InetSocketAddress(local,30000);
}
