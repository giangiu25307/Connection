...
import com.example.connection.libs.http.ProtocolVersion;
import com.example.connection.libs.http.RequestLine;
import com.example.connection.libs.http.body.AsyncHttpRequestBody;

import java.util.Locale;

public class AsyncHttpRequest {
    public com.example.connection.libs.http.RequestLine getRequestLine() {
        return new RequestLine() {
            ...
            @Override
            public com.example.connection.libs.http.ProtocolVersion getProtocolVersion() {
    ...
    public static void setDefaultHeaders(com.example.connection.libs.http.Headers ret, Uri uri) {
        if (uri != null) {
    ...
    public AsyncHttpRequest(Uri uri, String method, com.example.connection.libs.http.Headers headers) {
        mMethod = method;
        this.uri = uri;
        if (headers == null)
            mRawHeaders = new com.example.connection.libs.http.Headers();
        else
            mRawHeaders = headers;
        if (headers == null)
    ...
    private com.example.connection.libs.http.Headers mRawHeaders = new com.example.connection.libs.http.Headers();
