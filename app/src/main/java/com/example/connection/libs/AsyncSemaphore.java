...
public class AsyncSemaphore {
    ...
    public void acquire() throws InterruptedException {
        com.example.connection.libs.ThreadQueue threadQueue = com.example.connection.libs.ThreadQueue.getOrCreateThreadQueue(Thread.currentThread());
...
//                        Log.i(LOGTAG, "Pumping for AsyncSemaphore");
    ...
    public void release() {
        semaphore.release();
        com.example.connection.libs.ThreadQueue.release(this);
    }
}
